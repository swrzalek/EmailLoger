            ...
            >
                <v-row justify="center">
                  ...
                  <v-text-field
                            ...
                            v-model="email"
                        ></v-text-field>
                                <v-btn class="mr-8 my-4"
                                @click="createAccess()">Utwórz dostęp</v-btn>
                                  <v-btn @click="copyToClipboard()">Skopiuj do schowka</v-btn>
                  </v-col>
                </v-row>
                <v-row justify="center">
                   <v-col cols="12" md="6">
...
export default {
  ...
  computed: {
    html: () => {
      ...
      let link = `${APP_URL}/id=${hashEmail('stian.uek@gmail.com')}`;
      // eslint-disable-next-line prefer-const
  ...
  methods: {
    ...
    copyToClipboard() {
      const input = document.getElementById('emailContent');
      input.select();
